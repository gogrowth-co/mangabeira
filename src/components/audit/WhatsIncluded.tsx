    ...
    <section className="py-20 lg:py-28 bg-background">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map((item, i) => (
            <div key={i} className="bg-muted rounded-xl p-6 border-l-4 border-[hsl(var(--aqua-bright))] hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
              <span className="text-3xl mb-4 block">{item.icon}</span>
              <h3 className="font-hero font-semibold text-lg text-primary mb-2">
                {item.title}
              </h3>
