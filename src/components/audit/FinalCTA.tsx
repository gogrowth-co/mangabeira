...
const FinalCTA = () => {
  return (
    <section className="bg-[#0A2540] py-24 px-6 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <Button
          size="lg"
          className="bg-[#FFB800] text-[#0A2540] font-bold px-10 py-5 rounded-lg text-lg hover:scale-105 hover:shadow-xl transition-all duration-300 mt-8"
