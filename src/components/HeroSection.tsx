...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#0A0F1A]/95 via-[rgba(10,15,26,0.80)] to-[rgba(10,15,26,0.75)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.20)_100%)]" />
      <div className="absolute inset-0 backdrop-blur-[6px] md:backdrop-blur-[5px]" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-16">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left max-w-[720px] lg:bg-[rgba(10,15,26,0.35)] lg:backdrop-blur-[3px] lg:rounded-xl lg:p-5">
            ...
            <h1 
              className="text-white-pure mb-3 md:mb-4 leading-tight animate-fade-in text-[1.75rem] sm:text-5xl md:text-6xl lg:text-[3.5rem] xl:text-7xl"
              style={{ textShadow: 'var(--text-shadow-hero)' }}
            >
              <span className="font-accent font-bold">Gabriel</span> <span className="font-accent font-extrabold relative inline-block">Mangabeira<span className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-[rgba(43,179,255,0.4)] to-[rgba(43,179,255,0.2)]"></span></span>
            </h1>
            ...
            {/* Credibility Stats - Bold Numbers, Light Gray Dividers */}
            <div className="mb-6 md:mb-7 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="flex flex-col sm:flex-row items-center lg:items-start lg:justify-start justify-center gap-3 sm:gap-4 text-white-pure/92 text-sm sm:text-base md:text-base">
                <div className="flex items-center gap-2">
                  <Medal size={20} color="#FFB020" strokeWidth={2} className="flex-shrink-0 opacity-90" />
                  <span className="font-body"><span className="font-bold">1M+</span> SEO Readers</span>
                </div>
                <span className="hidden sm:inline text-white-pure/30 px-2">|</span>
                <div className="flex items-center gap-2">
                  <Globe size={20} color="#FFB020" strokeWidth={2} className="flex-shrink-0 opacity-90" />
                  <span className="font-body"><span className="font-bold">$3.3M+</span> Crowdfunded</span>
                </div>
                <span className="hidden sm:inline text-white-pure/30 px-2">|</span>
                <div className="flex items-center gap-2">
                  <TrendingUp size={20} color="#FFB020" strokeWidth={2} className="flex-shrink-0 opacity-90" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start animate-fade-in mt-6 md:mt-7" style={{ animationDelay: '0.4s' }}>
              <Button 
                variant="hero" 
                size="hero" 
                className="w-full sm:w-auto px-7 sm:px-8 py-4 sm:py-4.5 font-semibold text-base sm:text-lg bg-gradient-cta text-white shadow-button hover:shadow-button-hover hover:scale-105 transition-all duration-300"
              >
              ...
              <Button 
                ...
                size="hero" 
                className="w-full sm:w-auto px-7 sm:px-8 py-4 sm:py-4.5 text-base sm:text-lg bg-transparent border-2 border-white text-white hover:bg-aqua-bright/20 hover:border-aqua-bright hover:scale-105 transition-all duration-300"
              >
                See My Results
              </Button>
            </div>
          ...
          {/* Profile Photo - Clean with Thin Outline & Glow */}
          <div className="order-1 lg:order-2 animate-fade-in lg:pr-12 xl:pr-16">
            <div className="relative">
              {/* Soft Shadow Glow */}
              <div className="absolute inset-0 rounded-full shadow-[0_16px_40px_rgba(0,0,0,0.4)]"></div>
              {/* Profile Image with Thin White Outline */}
              <div className="relative w-36 h-36 sm:w-40 sm:h-40 md:w-44 md:h-44 lg:w-60 lg:h-60 xl:w-[260px] xl:h-[260px] rounded-full overflow-hidden flex-shrink-0 ring-[3px] ring-white/70 ring-offset-0">
                <img 
                  src={gabrielAvatar} 
