...
const SEO = ({ locale, path = '/' }: SEOProps) => {
  ...
  return (
    <Helmet>
      ...
      {/* RSS Feeds */}
      <link rel="alternate" type="application/rss+xml" title="Mangabeira.net RSS Feed (English)" href={`${baseUrl}/rss/rss-en.xml`} hrefLang="en" />
      <link rel="alternate" type="application/rss+xml" title="Mangabeira.net RSS Feed (Portuguese)" href={`${baseUrl}/rss/rss-br.xml`} hrefLang="pt-BR" />
      <link rel="alternate" type="application/rss+xml" title="Mangabeira.net RSS Feed (Spanish)" href={`${baseUrl}/rss/rss-es.xml`} hrefLang="es" />
